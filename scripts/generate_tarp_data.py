...
from coverage_funcs import bootstrapping, get_drp_coverage, mean_coverage
...
def main(args):
    ...
    # Attempt at handling corrupted files
    ...
    if args.sanity_plot:  
        ...
        fig_dir = os.path.join(args.results_dir, "sanity_check.jpeg")
        plt.savefig(fig_dir, bbox_inches="tight", pad_inches=0.2)
